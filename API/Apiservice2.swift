...
class Apiservice2: NSObject {
    ...
    class func register2(fullname:String,username:String,email:String,password:String,Number:String,namecompnay:String,listprovider:String ,longlat:String,completion: @escaping (_ error: Error?, _ success: Bool)->Void){
