...
class register2ViewController: UIViewController, UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet var Importphoto: UIImageView!
    ...
    @IBOutlet var longlat: UITextField!
